...
export default function Home() {
  ...
  const loadData = async () => {
    try {
      // Until you have real login, just fetch the latest 3 sessions
      // or return an empty array if PhotoSession.filter isn't ready yet.
      const sessions = await PhotoSession.filter({}, "-created_date", 3);
